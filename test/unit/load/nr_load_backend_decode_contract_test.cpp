...
const nr::test::CaseRegistrar assimpTextureSemanticCase{
    "assimp material texture semantics map to resource slots", [] {
        ...
        auto cases = std::array{
            ...
            SemanticCase{.textureTypeRaw = 15u, .expected = metallicRoughness},
            SemanticCase{.textureTypeRaw = 16u, .expected = metallicRoughness},
            SemanticCase{.textureTypeRaw = 27u, .expected = metallicRoughness},
            SemanticCase{.textureTypeRaw = 2u, .textureSlot = 0u, .expected = unsupported},
            SemanticCase{.textureTypeRaw = 2u, .textureSlot = 1u, .expected = unsupported},
            SemanticCase{.textureTypeRaw = 2u, .textureSlot = 2u, .expected = unsupported},
