...
const nr::test::CaseRegistrar revisionSetCase{
    "utils revision set snapshots and projections use exact fixed-storage values", [] {
...
const nr::test::CaseRegistrar revisionBatchCase{
    "utils revision batches advance policy domains only after explicit commit", [] {
...
const nr::test::CaseRegistrar revisionBundleCase{
    "utils revision bundles aggregate heterogeneous domains without custom owner logic", [] {
