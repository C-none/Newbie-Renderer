...
void requireContiguousCoverage(
    const nr::threading::WorkRangePlan& plan,
...
const nr::test::CaseRegistrar rangePlannerCase{
    ...
    [] {
        ...
        nr::test::require(std::ranges::all_of(twenty.ranges, [](const nr::threading::WorkRange& range) {
...
const nr::test::CaseRegistrar submitCase{
    ...
    [] {
        ...
        std::ranges::for_each(taskIndices, [&](std::uint32_t) {
            static_cast<void>(pool.submit([&counter] {
