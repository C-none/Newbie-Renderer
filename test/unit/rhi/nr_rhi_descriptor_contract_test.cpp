...
[[nodiscard]] nr::rhi::DescriptorBindingInfo makeDescriptorBinding(
    std::uint32_t set,
...
[[nodiscard]] nr::rhi::DescriptorWriteRequest makeBufferWrite(
    std::uint32_t set,
    std::uint32_t binding,
    ...
    vk::DeviceSize range)
{
    return nr::rhi::DescriptorWriteRequest{
        ...
        .payload = nr::rhi::BufferDescriptorWrite{
...
const nr::test::CaseRegistrar descriptorWriteCacheBufferCase{
    ...
    [] {
        ...
        nr::test::requireEqual(changed.size(), std::size_t{1}, "different array element should be a distinct cache slot");
    ...
    [] {
        ...
        auto writes = std::vector<nr::rhi::DescriptorWriteRequest>{
            nr::rhi::DescriptorWriteRequest{
                ...
                .payload = nr::rhi::ImageDescriptorWrite{
            ...
            nr::rhi::DescriptorWriteRequest{
                ...
                .payload = nr::rhi::TexelBufferDescriptorWrite{
            ...
            nr::rhi::DescriptorWriteRequest{
                ...
                .payload = nr::rhi::AccelerationStructureDescriptorWrite{
                    .accelerationStructure = vk::AccelerationStructureKHR{fakeVkHandle<VkAccelerationStructureKHR>(0x4001u)},
                },
            },
            nr::rhi::DescriptorWriteRequest{
                .binding = makeDescriptorBinding(0u, 3u, vk::DescriptorType::eInlineUniformBlock),
                .payload = nr::rhi::InlineUniformDescriptorWrite{
        ...
        std::get<nr::rhi::TexelBufferDescriptorWrite>(modifiedWrites[1].payload).view = vk::BufferView{fakeVkHandle<VkBufferView>(0x3002u)};
