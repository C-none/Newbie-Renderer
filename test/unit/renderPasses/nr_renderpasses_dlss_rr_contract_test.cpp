...
const nr::test::CaseRegistrar dlssRrSourceBoundaryCase{"renderpasses DLSS RR is exported, staged, and explicitly installed in rtobject", [] {
                                                           ...
                                                           requirePresent(rtObjectPipeline, "input.enabled = true", "rtobject should enable its explicitly installed RR node");
                                                           ...
                                                           requirePresent(rtObjectPipeline, "activeNode->effectiveResolutionRequest()", "rtobject RR resolver must read the node's sole staged configuration authority");
