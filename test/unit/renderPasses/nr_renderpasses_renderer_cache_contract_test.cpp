...
const nr::test::CaseRegistrar migratedRenderPassBranchSnapshotsCase{
    "all rtobject nodes opt into exact Skeleton branch snapshots", [] {
        ...
        dlssDebugSnapshot.values.insert_or_assign(nr::options::optionId(nr::options::keys::dlssVisualizeMotionVectors),
                                                  nr::options::OptionWireValue{true});
        auto const dlssAlphaDebug = dlss.structuralSnapshot(nr::renderer::NodeFrameParameters{
...
const nr::test::CaseRegistrar renderPassesRendererCacheOwnershipCase{
    "renderpasses no longer own renderer/RDG descriptor table cache state", [] {
        ...
        requirePresent(
            rendererImplementation, "MissingMaterialTexturePolicy::allowUnavailableAnisotropy",
            "TLAS texture collection should explicitly opt into the anisotropy-only unavailable-texture policy");
        ...
        requirePresent(rendererCacheInterface, "reinterpret_cast<std::uintptr_t>",
                       "BindlessImageTableCache should key table ownership by pipeline runtime object address within "
                       "the cache lifetime");
        ...
        requirePresent(accumulate, "std::optional<AccumulateCameraTransform> previousCameraTransform{}",
        ...
        requirePresent(accumulate, "accumulateCameraTransformsEquivalent",
...
const nr::test::CaseRegistrar sceneRtMutationPolicyCase{
    "scene RT mutation policy separates dynamic and static cache invalidation", [] {
        ...
        nr::test::requireEqual(nr::scene::SceneRevisionMutationPolicy::mask(Mutation::externalTransform),
                               Mask::of<Domain::transform>());
        nr::test::requireEqual(nr::scene::SceneRevisionMutationPolicy::mask(Mutation::externalTraceMask),
                               Mask::of<Domain::traceMask>());
        nr::test::requireEqual(nr::scene::SceneRevisionMutationPolicy::mask(Mutation::externalVisibility),
                               Mask::of<Domain::topology, Domain::visibility>());
        ...
        nr::test::requireEqual(nr::scene::SceneRevisionMutationPolicy::mask(Mutation::instanceRemoved),
                               Mask::of<Domain::topology, Domain::transform, Domain::visibility, Domain::traceMask,
                                        Domain::meshBinding>());
        nr::test::requireEqual(nr::scene::SceneRevisionMutationPolicy::mask(Mutation::externalMeshBinding),
                               Mask::of<Domain::topology, Domain::meshBinding>());
        nr::test::requireEqual(nr::scene::SceneRevisionMutationPolicy::mask(Mutation::externalMaterialPayload),
                               Mask::of<Domain::materialPayload>());
        nr::test::requireEqual(nr::scene::SceneRevisionMutationPolicy::mask(Mutation::externalMaterialBinding),
                               Mask::of<Domain::topology, Domain::materialBinding>());
        nr::test::requireEqual(nr::scene::SceneRevisionMutationPolicy::mask(Mutation::externalMeshContent),
                               Mask::of<Domain::meshContent>());
        nr::test::requireEqual(nr::scene::SceneRevisionMutationPolicy::mask(Mutation::externalMeshLayout),
                               Mask::of<Domain::topology, Domain::meshLayout>());
        nr::test::requireEqual(nr::scene::SceneRevisionMutationPolicy::mask(Mutation::externalTextureBinding),
                               Mask::of<Domain::topology, Domain::textureBinding>());
        nr::test::requireEqual(nr::scene::SceneRevisionMutationPolicy::mask(Mutation::externalTextureContent),
                               Mask::of<Domain::textureContent>());
        nr::test::requireEqual(nr::scene::SceneRevisionMutationPolicy::mask(Mutation::externalTextureResidency),
        ...
        nr::test::requireEqual(nr::scene::SceneRevisionMutationPolicy::mask(Mutation::materialResident),
                               Mask::of<Domain::topology, Domain::materialPayload>());
        nr::test::requireEqual(nr::scene::SceneRevisionMutationPolicy::mask(Mutation::textureResident),
                               Mask::of<Domain::topology, Domain::textureResidency>());
        nr::test::requireEqual(
            nr::scene::SceneRevisionMutationPolicy::mask(Mutation::externalEcsMutation),
            Mask::of<Domain::topology, Domain::transform, Domain::visibility, Domain::traceMask, Domain::meshBinding,
                     Domain::meshContent, Domain::meshLayout, Domain::materialBinding, Domain::materialPayload,
                     Domain::textureBinding, Domain::textureContent, Domain::textureResidency>());
...
const nr::test::CaseRegistrar presentLinearExrScreenshotCase{
    "present screenshots read back linear source images and write EXR", [] {
        ...
        requirePresent(presentInterface, "vk::Format format = vk::Format::eUndefined",
        ...
        requirePresent(
            present, "!screenshotPrepared_.has_value() &&\n        !screenshotPendingSave_.has_value()",
            "capture availability must remain conservatively busy while dispatch or continuation state exists");
        ...
        requirePresent(present, "if (!targetBatchSubmitted || screenshotPendingSave_.has_value())",
                       "capture must not arm its continuation unless the target batch submitted");
        requireOrdered(present, "if (!targetBatchSubmitted || screenshotPendingSave_.has_value())",
        ...
        requirePresent(present, "screenshotPendingSave_->frameSlot != frameSlot",
...
const nr::test::CaseRegistrar pathTracingShaderOrganizationCase{
    "path tracing shader keeps raygen core separate from material hit shaders", [] {
        ...
        auto entryPoints = raygenEntry + missEntry + anyHitEntry + shadowMissEntry + shadowAnyHitEntry + closestHitEntry;
        ...
        requirePresent(core, "float4 lightRandomValues = path.rng.rand4();",
        ...
        requirePresent(params, "public static const uint kDirectLightSampleCount = 4u;",
                       "PathTracing direct-light packet layout requires exactly four samples");
        ...
        requirePresent(materialPayload, "evaluateResolvedMaterialBsdfComponentsVariant",
                       "Material payload should expose variant-aware BSDF component evaluation");
        requirePresent(materialPayload, "evaluateResolvedMaterialDirectComponentsVariant",
        ...
        requirePresent(visibility,
                       "uint(RtRayType.shadow), uint(RtRayType.count), uint(RtRayType.shadow)",
                       "visibility rays should route through the independent shadow ray type");

        requirePresent(anyHitPolicy, "resolveAlphaCoverage", "PathTracing any-hit should resolve only alpha coverage");
        ...
        requireAbsent(pathTracingSbt, ".stride =",
                      "SBT byte stride must remain RHI-computed rather than encode the ray-type count");
        ...
        requirePresent(materialPayload, "sampleResolvedMaterialScatterVariant",
        ...
        requirePresent(materialPayload, "evaluateResolvedMaterialDirect",
                       "Common material payload helper should expose direct lighting evaluation");
        requirePresent(materialPayload, "sampleResolvedMaterialScatter",
                       "Common material payload helper should expose v1 scatter sampling");
    }};
...
const nr::test::CaseRegistrar skeletonPatchCapabilityCase{
    "all rtobject nodes expose exact patch-only Skeleton materialization", [] {
        ...
        requirePresent(ui, "runtime_->preparedDrawFrame = detail::prepareUiDrawFrame",
