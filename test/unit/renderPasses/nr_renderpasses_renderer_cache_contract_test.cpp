...
const nr::test::CaseRegistrar pathTracingShaderOrganizationCase{"path tracing shader keeps raygen core separate from material hit shaders", [] {
                                                                    ...
                                                                    requirePresent(materialPayload, "public struct BaseSurfaceBsdfLobe<let LayerFlags", "Common material payload helper should expose the shared base/transmission lobe");
