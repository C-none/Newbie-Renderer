...
const nr::test::CaseRegistrar pathTracingShaderOrganizationCase{"path tracing shader keeps raygen core separate from material hit shaders", [] {
                                                                    ...
                                                                    requirePresent(core, "roulettePolicy.survivalProbability(pathCombinedThroughput(path))", "PathTracing roulette should use the combined split throughput");
                                                                    ...
                                                                    requirePresent(visibility, "RAY_FLAG_SKIP_CLOSEST_HIT_SHADER | RAY_FLAG_ACCEPT_FIRST_HIT_AND_END_SEARCH,\n        0xFF,\n        0,\n        1,\n        0,", "visibility rays should use the same hit SBT offset/stride 0/1");
