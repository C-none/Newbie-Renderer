...
const nr::test::CaseRegistrar textureIntentPlanCase{
    "scene bridge plan canonicalizes texture identity with final sampling color intent", [] {
        ...
        sceneAsset.materials = {
            ...
            nr::load::MaterialAsset{
                .name = "specular_alpha_and_color",
                .textures =
                    {
                        nr::load::MaterialTextureBinding{
                            .textureIndex = 3u,
                            .semantic = nr::resource::MaterialTextureSlotSemantic::specular,
                        },
                        nr::load::MaterialTextureBinding{
                            .textureIndex = 3u,
                            .semantic = nr::resource::MaterialTextureSlotSemantic::specularColor,
                        },
                        nr::load::MaterialTextureBinding{
                            .textureIndex = 4u,
                            .semantic = nr::resource::MaterialTextureSlotSemantic::specular,
        ...
        nr::test::requireEqual(plan.textures[3].samplingColorIntent, nr::scene::TextureSamplingColorIntent::srgb);
        nr::test::requireEqual(plan.textures[4].samplingColorIntent, nr::scene::TextureSamplingColorIntent::linear);
        ...
        nr::test::require(!plan.textures[3].mixedColorAndLinearReferences,
                          "specular alpha remains linear under the shared specular-color sRGB view");
        nr::test::require(!plan.textures[4].mixedColorAndLinearReferences);
        ...
        nr::test::requireEqual(plan.textures[0].canonicalKey, plan.textures[3].canonicalKey,
                               "packed specular color and alpha should retain the sRGB texture identity");
        nr::test::requireEqual(plan.textures[1].canonicalKey, plan.textures[4].canonicalKey,
                               "scalar-only specular should retain the linear texture identity");
    }};
