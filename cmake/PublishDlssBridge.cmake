...
set(published_manifest "{}")
string(JSON published_manifest SET "${published_manifest}" schemaVersion 1)
string(JSON published_manifest SET "${published_manifest}" bridgeAbi 1)
string(JSON published_manifest SET "${published_manifest}" sdkVersion "\"310.7.0\"")
string(JSON published_manifest SET "${published_manifest}" platform "\"windows\"")
string(JSON published_manifest SET "${published_manifest}" architecture "\"x86_64\"")
string(JSON published_manifest SET "${published_manifest}" configuration "\"Release\"")
string(JSON published_manifest SET "${published_manifest}" runtime "\"MT\"")
string(JSON published_manifest SET "${published_manifest}" apiHeaderSha256 "\"${publish_HEADER_SHA256}\"")
string(JSON published_manifest SET "${published_manifest}" bridgeInputsSha256 "\"${publish_INPUTS_SHA256}\"")
string(JSON published_manifest SET "${published_manifest}" ngxLoaderSha256 "\"${publish_LOADER_SHA256}\"")
string(JSON published_manifest SET "${published_manifest}" dllSha256 "\"${bridge_dll_sha256}\"")
string(JSON published_manifest SET "${published_manifest}" export "\"nrDlssBridgeGetApi\"")
file(WRITE "${temporary_manifest}" "${published_manifest}\n")
