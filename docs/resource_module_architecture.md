...
- Legacy specular-glossiness authoring inputs are converted by `scene` before they enter `nr.resource`; they remain distinct from the canonical modern specular extension.
