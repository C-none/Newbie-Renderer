...
# Compile one shader through the same ShaderService path used by the renderer:
...
if(NOT DEFINED NR_SHADER_FILE OR NR_SHADER_FILE STREQUAL "")
    message(FATAL_ERROR
        "NR_SHADER_FILE is required and must name a Slang module under the configured shader root."
    )
endif()
...
set(nr_shader_file "${NR_SHADER_FILE}")
...
if(NOT nr_shader_check_result STREQUAL "0")
    message(FATAL_ERROR
        "Shader compilation failed for '${nr_shader_module_path}' "
        "with result '${nr_shader_check_result}'."
    )
endif()

message(STATUS
    "Shader '${nr_shader_module_path}' passed the runtime-equivalent Slang compile check."
)
