...
typedef uint32_t(NR_DLSS_BRIDGE_CALL* NrDlssBridgeGetInstanceExtensionsFn)(
    uint32_t* count,
    NrDlssBridgeExtensionName* names,
    NrDlssBridgeStatus* status);
typedef uint32_t(NR_DLSS_BRIDGE_CALL* NrDlssBridgeGetDeviceExtensionsFn)(
    VkInstance instance,
    VkPhysicalDevice physicalDevice,
    uint32_t* count,
    NrDlssBridgeExtensionName* names,
    NrDlssBridgeStatus* status);
typedef uint32_t(NR_DLSS_BRIDGE_CALL* NrDlssBridgeCreateContextFn)(
...
typedef uint32_t(NR_DLSS_BRIDGE_CALL* NrDlssBridgeContextAvailableFn)(
    const NrDlssBridgeContext* context);
typedef uint32_t(NR_DLSS_BRIDGE_CALL* NrDlssBridgeGetOptimalSettingsFn)(
    NrDlssBridgeContext* context,
    NrDlssBridgeDimensions targetSize,
    uint32_t quality,
...
NR_DLSS_BRIDGE_API uint32_t NR_DLSS_BRIDGE_CALL nrDlssBridgeGetApi(
