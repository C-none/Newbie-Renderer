...
- Expose third-party functionality through the narrow `dependency.*` modules defined in `src/AGENTS.md` `## Dependencies`; do not place project business or renderer logic in vendored trees.
