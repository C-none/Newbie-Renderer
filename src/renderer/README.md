...
- `RenderGraphCompileCache` caches compiled graph templates by resource/pass/submit structure and patches current frame data, callbacks, imported resource refs, and debug names on a hit. Debug names and swapchain image indices do not participate in the cache key.
