...
inline constexpr std::string_view sceneRtNeuralMaterialRefs = "scene.rt.neuralMaterialRefs";
inline constexpr std::string_view sceneRtNeuralModelParameters = "scene.rt.neuralModelParameters";
inline constexpr std::string_view sceneRtNeuralLatentTexture0 = "scene.rt.neuralLatentTexture0";
inline constexpr std::string_view sceneRtNeuralLatentTexture1 = "scene.rt.neuralLatentTexture1";
