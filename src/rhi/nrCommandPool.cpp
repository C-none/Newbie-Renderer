...
namespace nr::rhi
{
CommandPool::CommandPool(const vk::raii::Device &device, std::uint32_t queueFamilyIndex, vk::CommandPoolCreateFlags flags) : queueFamilyIndex_(queueFamilyIndex), device_(std::ref(device))
{
