...
[[nodiscard]] ShaderBindingTable ShaderBindingTable::create(const ResourceFactory &resourceFactory, const ShaderBindingTableBuildDesc &desc)
{
        auto validation = rt_detail::validateShaderBindingTableBuildDesc(desc);
...
[[nodiscard]] vk::TraceRaysIndirectCommand2KHR ShaderBindingTable::traceRaysIndirectCommand2(TraceRaysDimensions dimensions) const noexcept
{
